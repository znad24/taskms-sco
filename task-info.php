              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  <div class="form-group">
                    <label class="control-label text-p-reset">Task</label>
                    <div class="">
				...
				<select class="form-control" name="task_category" id="task_category">
				  ...
				  <option value="INPUT DATA VENDOR">INPUT DATA VENDOR</option>
				  <option value="INPUT DATA CUSTOMER">INPUT DATA CUSTOMER</option>
				  <option value="INPUT DATA EMPLOYEE">INPUT DATA EMPLOYEE</option>		
				  <option value="CREATE MATERIAL">CREATE MATERIAL</option>
				  <option value="QUALITY INPECTION">QUALITY INPECTION</option>
				  <option value="CREATE PLU">CREATE PLU</option>\
				  <option value="UPLOAD BOM">UPLOAD BOM</option>
				  <option value="CREATE GL">CREATE GL</option>
                  <option value="CREATE COMMITMENT ITEM">CREATE COMMITMENT ITEM</option>				  
				</select>
				</div>-->
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label text-p-reset">Master Data Employee</label>
                    <div class="">
                      <?php 
                        $sql = "SELECT user_id, fullname FROM tbl_admin WHERE user_id = 30";
      ...
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <div class="table-responsive">
			...
			// Total row count
					if ($user_role == 1) {
					$count_sql = "SELECT COUNT(*) FROM task_info";
					} else {
					$count_sql = "SELECT COUNT(*) FROM task_info WHERE t_user_id = $user_id";
					}
					$total_rows = $obj_admin->manage_all_info($count_sql)->fetchColumn();
			  ...
			  $sql = "SELECT a.*, b.fullname 
				...
				$sql .= " ORDER BY a.task_id DESC LIMIT $limit OFFSET $offset";
